      ...
      <div class="container logo-wrap">
        <div class="row pt-5">
          <div class="col-12 text-center">
            ...
            <h2 class="site-logo"><router-link :to="{name:'Home'}"> The History of Iraq </router-link></h2>
...
"> حول </router-link>
              ...
              <!-- <li class="nav-item">
               ...
               <li class="nav-item" v-for="h in categoryHed" :key="h.id">
                <router-link  onclick="location.reload();" class="nav-link" :to="{ name: 'category.page',
                        params: {
            ...
            <div class="sidebar-box">
              ...
              <div class="post-entry-sidebar">
                <ul>
                  ...
                  <li onclick="location.reload();"  v-for="m in postMostView.data" :key="m.id">
                    <router-link  :to="{ name: 'singl.post',
                        params: {
                            id: m.slug} }">
                      <img :src="'/images/posts/'+ m.image" alt="Image placeholder" class="mr-4">
                      <div class="text">
                        <h4>{{m.title |truncate(55)}}</h4>
                        <div class="post-meta">
...
"> الاقسام</h1>
     ...
     <footer class="site-footer" style="text-align: initial;">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-4">
            <h3>وصف الموقع</h3>
            <p>
              <img src="/assets/images/big_image_3.jpg" alt="Image placeholder" class="img-fluid">
            </p>
            ...
            <div class="row">
             ...
             <li class="nav-item">
                <router-link  :to="{name: 'About'}"> حول </router-link>
                     ...
                     <li class="nav-item" v-for="h in categoryHed" :key="h.id">
                <router-link  onclick="location.reload();"  :to="{ name: 'category.page',
                        params: {
                            id: h.id} }" style="  color: #ffffff;">{{h.name}}</router-link>
              </li>
                  </ul>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
 {{s|myDateDay}}  جميع الحقوق محفوظة © العراق مهد الحضارات
...
mounted() {
  ...
  methods: {
   ...
   fetch() {
         this.$axios.get('/api/res-search', { params: { keywords: this.keywords } })
    ...
    getResul() {
                 this.$axios.get('/api/posts/mostview')
                   .then(data => {
             ...
             category() {
                 this.$axios.get('/api/categoryAll')
                   .then(data => {
